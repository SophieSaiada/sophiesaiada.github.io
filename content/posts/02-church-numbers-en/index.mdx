...
The mapping is working for both direction! 🥳  
...
The plus sign in the left side represents an addition between two natural numbers. The result of this addition is mapped to a Church function by C*E.  
...
The result of $C_n+C_m$ should be the function \$C*{n+m}$, the Church function who takes two parameters, $f$ and $x$, and returns $f$ applied on $x$, $n+m$ times. In the same way we will define the multiplication between Church functions. The result of $C*n\*C_m$ is $C*{n\*m}\$.
