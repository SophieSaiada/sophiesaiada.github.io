...
$C_n$ receives two parameters. The first is a function name $f$, who maps some element of type $T$ to some element of type $T$. The second parameter is a value of type $T$, named $x$.  
